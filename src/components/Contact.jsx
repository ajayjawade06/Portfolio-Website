  ...
  return (
    <>
      <div className="container contact" id="contact">
        ...
        >
          <a href="https://www.instagram.com/ajujawade/" target="_blank" className="items">
          ...
          <a href="https://github.com/ajujawade" target="_blank" className="items">
            <FaGithubSquare className="icons" />
          </a>
          <a
            href="mailto:ajayjawade06@gmail.com"
            target="_blank"
            className="items"
          >
